...
int main(void)
{
    double weights[] = {3, 5, 2, 1,2,5,6,4,5,1,2,4,3,5,6,1,2,2,4,3,5,1,3,4,6,5,6,4,2,3,5,1,5,3,4,1,6,2,4,6,2,1,5,2,1,3,4,5,2,1,2};
    double profits[] = {9, 10,7, 4,10,2,4,9,8,3,11,2,10,11,7,99,8,7,5,6,12,13,10,9,8,7,8,9,7,8,11,7,13,7,9,8,6,4,8,9,7,6,5,10,4,6};
    const size_t n = sizeof(profits) / sizeof(profits[0]);
    const double capacity = 12;
